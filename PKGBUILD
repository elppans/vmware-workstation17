...
sha256sums=(
  ...
  'c7739e218165d1dea76222fb89a8823b745fa662c02ae74898e041a7a26285a5'
  ...
  '423bdeec22701b29243233b613f32f66bf4657e031da08abef8ad158e5b04fe5'
  'b4fb7e3e28be28c7ed94b2baf126e55f9eecd3847f65736862c266e631b45a73'
  'e1edd96bb14e9b8e046409bc02bb498c9c7e12cef6421a7cb6fa51edba781a66'
)
...
package() {
  ...
  mkdir -p \
    ...
    "$pkgdir/usr/lib"/{vmware/setup,vmware-vix,vmware-ovftool,vmware-installer/"$vmware_installer_version",modules}/"$(uname -r)" \
...
if [ -z "$_remove_vmware_keymaps_dependency" ]; then
  ...
  echo -e "vmw_vmci\nvmmon" > "$pkgdir/usr/lib/modules/"$(uname -r)"/vmware.conf"
...
# Custom MOD:
  ...
  install -Dm 644 "$srcdir"/extracted/vmware-vmx/systemd/vmware.service "$pkgdir/usr/lib/systemd/system/vmware.service"
  install -Dm 755 "$srcdir"/postinst "$pkgdir"/DEBIAN/postinst
  install -Dm 755 "$srcdir"/preinst "$pkgdir"/DEBIAN/preinst
